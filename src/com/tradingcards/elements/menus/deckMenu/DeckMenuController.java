...
public class DeckMenuController {
    ...
    public DeckMenuController(DeckMenuView view, DeckController deckController, DeckView deckView, MainMenuView mainMenuView, MainFrame mainFrame){
    ...
    public DeckMenuView getView(){return view;}
